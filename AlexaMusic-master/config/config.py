...
BOT_TOKEN = getenv("8406951390:AAEEp8Yk8bM9ku1mvNy6Z5xvfzASjCZSHOs")

MONGO_DB_URI = getenv("mongodb+srv://winpyaekyaw665_db_user:Wpk332004@cluster0.b8kfswd.mongodb.net/?appName=Cluster0", None)

DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", "900"))

SONG_DOWNLOAD_DURATION = int(getenv("SONG_DOWNLOAD_DURATION_LIMIT", "180"))

LOG_GROUP_ID = int(getenv("LOG_GROUP_ID",-1003324492618 ""))

MUSIC_BOT_NAME = getenv("Music Myanmar Bot")

OWNER_ID = int(getenv("1794465007", None))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/BurmaMusicMyanmar")

SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/BurmaMusicGroup")
